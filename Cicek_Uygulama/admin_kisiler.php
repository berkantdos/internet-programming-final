...
if(isset($_GET['delete'])){
   ...
   header('location:admin_kisiler.php');
}
...
<section class="messages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Telefon No : <span><?php echo $fetch_message['number']; ?></span> </p>
         <p>E-mail : <span><?php echo $fetch_message['email']; ?></span> </p>
         <p>Mesaj : <span><?php echo $fetch_message['message']; ?></span> </p>
         <a href="admin_kisiler.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('Mesajı Silmek İstiyor Musunuz?');" class="delete-btn">Sil</a>
      </div>
      <?php
         }
      }else{
